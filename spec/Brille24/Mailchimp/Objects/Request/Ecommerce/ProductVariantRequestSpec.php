...
use Brille24\Mailchimp\Objects\Request\Ecommerce\ProductVariantRequest;
...
class ProductVariantRequestSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(ProductVariantRequest::class);
    }
    ...
    {
        $this->getPrimaryResource()->shouldReturn('ecommerce/stores/store-ident/products/product-ident/variants');
    }
    ...
    public function it_throws_an_exception_if_a_primary_resource_has_no_identifier(
        ...
        $this->shouldThrow(
            new \InvalidArgumentException('A ProductVariantRequest can only be used with a Product-Identifier!')
        )->during(
